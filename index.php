...
<body>
    <div class="wrapper">
        ...
        <section class="section section_dark" id="tar">
            <div class="container">
                <div class="section__title">
                    <center>
                        <h3>Выберите свой вариант участия<br> и нажмите кнопку заказать!</h3> <br>
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col m6">
                            <form class="col" style="background-color: white; padding: 20px;" id="order-form" action="https://api.bpa.bz/api.client2crm/" method="POST">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        <select class="packet-select" name="packet" required>
                                            <option value="<?php echo $packets[1]["crm_name"]?>" disabled selected>Выберите пакет</option>
                                            <option value="<?php echo $packets[0]["crm_name"]?>"><?php echo $packets[0]["form_view_name"]?></option>
                                            <option selected value="<?php echo $packets[1]["crm_name"]?>"><?php echo $packets[1]["form_view_name"]?></option>
                                            <option value="<?php echo $packets[2]["crm_name"]?>"><?php echo $packets[2]["form_view_name"]?></option>
                                ...
                                <div class="row">
                                    <p>
                                        <label>
                                            ...
                                            <span>Согласен с условиями <a href="https://madinadmitriyeva.com/oferta/" target="_blank">Договора-оферты</a></span>
                                        </label>
                                    </p>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="price" class="form-price all-form-price" value="<?php echo $packets[1]["price"]?>" />
                                    <input type="hidden" name="convert_rub" class="form-price-rub all-form-price-rub" value="<?php echo $packets[1]["price_rub"]?>" />
                        ...
                        <div class="col m6">
                            <h4><span style="color:#FEEC1B;">ПРИ ОПЛАТЕ ПРЯМО СЕЙЧАС<br>СУПЕР БОНУСы: <br><br>
        ...
        <div class="cols">
          <div class="cols__col-4@lg">
            <section class="tarif">
              ...
              <ul class="list2">
                ...
                <li>Урок №3: Подбор квартиры (чек-лист "Идеальная квартира для субаренды", расчет финансовой стратегии,
                  договоренности с хозяином, тактика съема)</li>
                <li>Урок №4: Запуск квартиры (чек-лист готовой квартиры, требования к фото)</li>
                <li>Экземпляры всех необходимых договоров (Договор с гостями, Договор с менеджером, Договор с хозяином
                  квартиры)</li>
                <li>Набор Чек-листов (чек-лист Горничной, чек-лист Что должно быть в квартире, Правила проживания в
                  квартире, Должностные инструкции для менеджера)</li>
              ...
              <a class="btn order-popup" href="#popup" id="popup_packet1"
                data-packet="<?php echo $packets[0]["crm_name"]?>" data-price="
            <?php if ($gameOver) echo $packets[0]["price_high"]; else echo $packets[0]["price"];?>"
                data-price-rub="
          ...
          <div class="cols__col-4@lg">
            <section class="tarif">
              ...
              <ul class="list2">
                ...
                <li>Урок №7: Новые тенденциии в посуточной аренде квартир (Париж). Что выделит вас от конкурентов и
                  сделает №1 в вашем городе</li>
                <li>Экземпляры всех необходимых договоров (Договор с гостями, Договор с менеджером, Договор с хозяином
                  квартиры)</li>
                <li>Набор Чек-листов (Чек-лист Горничной, Чек-лист Что должно быть в квартире, Правила проживания в
                  квартире, Должностные инструкции для менеджера)</li>
                ...
                <li>WhatsApp чат - сообщество всех наших учеников (возможность найти себе наставника, партнера,
                  совместно взять горничную или/и менеджера на работу, сдавать квартиры друг друга)</li>
              ...
              <a class="btn order-popup" href="#popup" id="popup_packet2"
                data-packet="<?php echo $packets[1]["crm_name"]?>" data-price="
            <?php if ($gameOver) echo $packets[1]["price_high"]; else echo $packets[1]["price"];?>"
                data-price-rub="
          ...
          <div class="cols__col-4@lg">
            <section class="tarif">
              ...
              <a class="btn order-popup" id="popup_packet3" href="#popup"
                data-packet="<?php echo $packets[2]["crm_name"]?>" data-price="
            <?php if ($gameOver) echo $packets[2]["price_high"]; else echo $packets[2]["price"];?>"
                data-price-rub="
  ...
  <div id="popup" class="white-popup mfp-hide">
    ...
    <div class="row">
      <form class="col s12" id="order-form" action="https://api.bpa.bz/api.client2crm/" method="POST">
        ...
        <div class="row">
          <div class="input-field col s12">
            <input placeholder="Иванов Иван Иванович" id="firstname" name="firstname" required type="text"
              class="validate">
            <label for="title">Введите ваше ФИО</label>
          </div>
        </div>
        ...
        <div class="row">
          <p>
            <label>
              <input type="checkbox" class="filled-in" required />
              <span>Согласен с условиями <a href="https://madinadmitriyeva.com/oferta/"
                  target="_blank">Договора-оферты</a></span>
            </label>
          </p>
        </div>
  ...
  <script>
    ...
    */
    ...
    function gameOver() {
      ...
      $(".all-form-price").val( <?php echo $packets[1]["price_high"] ?> );
      $(".all-form-price-rub").val( <?php echo $packets[1]["price_rub_high"] ?> );
    }
