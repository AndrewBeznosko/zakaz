    ...
    <div class="container">
      <div class="section__title">
       <center> <h3>Выберите свой вариант участия<br> и нажмите кнопку заказать!</h3> </br>
		<h2><span style="color:#FEEC1B;">ПРИ ОПЛАТЕ ПРЯМО СЕЙЧАС - СУПЕР БОНУС: КУРС &quot;ДОХОДНЫЕ ДОМА&quot; В ПОДАРОК!</span></h2></br>
...
<div id="popup" class="white-popup mfp-hide">
    ...
    <div class="row">
      <form class="col s12" id="order-form" action="https://api.bpa.bz/api.client2crm/" method="POST">
        ...
        <div class="row">
          <div class="input-field col s12">
            <select id="packet-select" name="packet" required>
              <option value="Без пакета" disabled selected>Выберите пакет</option>
              <option value="<?php echo $packets[0]["crm_name"]?>">
        ...
        <div class="row">
          ...
          <input type="hidden" name="packet" id="form-packet" value="Без пакета" />
          <input type="hidden" name="price" id="form-price" value="1" />
          <input type="hidden" name="convert_rub" id="form-price-rub" value="1" />
          <button class="btn waves-effect waves-light" type="submit" name="action">Отправить заявку
